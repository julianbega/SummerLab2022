...
public class MemotestBox : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        movingDirection.x = Random.Range(mm.currentLevel.minSpeed, mm.currentLevel.maxSpeed);
        movingDirection.y = Random.Range(mm.currentLevel.minSpeed, mm.currentLevel.maxSpeed);
